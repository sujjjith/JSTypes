(function(root, mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    return mod(exports, require("../lib/infer"), require("../lib/tern"), require("acorn"), require("acorn/dist/walk"), require("../lib/transform"));
  if (typeof define == "function" && define.amd) // AMD
    return define(["exports", "../lib/infer", "../lib/tern", "acorn/dist/acorn", "acorn/dist/walk","../lib/transform"], mod);
  mod(root.tern || (root.tern = {}), tern, tern, acorn, acorn.walk, transform);
})(this, function(exports, infer, tern, acorn, walk, transform ) {
  "use strict";

  var ANONYMOUS_FN = "<anonymous>";
  var memberExpressionsNodes = [];
  ...
  var scopeVisitor = walk.make({
    ...
    MemberExpression : function(node, st, c){
    	memberExpressionsNodes.push(node);
    },
  ...
  tern.defineQueryType("outline", {
    ...
    run: function(server, query, file) {
      try {
        ...
        var transformed = transform.transform(ast, outline, memberExpressionsNodes,acorn);
        return {outline: transformed};
      } catch(err) {
